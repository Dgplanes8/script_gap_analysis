      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-700 mb-8 max-w-4xl mx-auto">
            Scale your subscription business 3x faster with weekly creative concepts and trend intelligence. 
            Built specifically for growth teams at subscription companies managing $10K+ monthly ad spend.
          </p>
