  ...
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
            ...
            <div key={index} className="bg-gray-50 rounded-xl p-6 border border-gray-200">
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="text-right">
                  <div className="text-2xl font-bold text-brand-600">{channel.effectiveness}%</div>
              ...
              <div className="grid md:grid-cols-3 gap-4 mb-6">
                <div>
                  ...
                  <div className="text-brand-600 font-medium">{channel.timeToValue}</div>
                </div>
                <div>
                  <div className="text-sm font-semibold text-gray-700">Average Cost</div>
                  <div className="text-brand-600 font-medium">{channel.avgCost}</div>
                </div>
                <div>
        ...
        <div className="mt-12 bg-gradient-to-r from-brand-50 to-brand-50 rounded-xl p-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-brand-600 mb-2">60/40</div>
