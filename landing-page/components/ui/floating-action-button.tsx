        ...
        <div className="absolute bottom-16 right-0 bg-white rounded-lg shadow-2xl border border-gray-200 p-4 w-64 transform transition-all duration-300">
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full bg-brand-50 border border-brand-200 text-brand-800 px-4 py-3 rounded-lg font-medium hover:bg-brand-100 transition-colors text-left"
            >
              <div className="font-semibold">🎯 Free 7-Day Pilot</div>
              <div className="text-xs text-brand-600 mt-1">Test our approach risk-free</div>
            </button>
