/**
 * Specialized FAQ data sets for different page types
 * Separated from client components to enable server-side imports
 * This prevents RSC module resolution errors
 */
