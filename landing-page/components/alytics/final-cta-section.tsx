...
export function FinalCTASection() {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-brand-600 to-brand-700 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-brand-600/20 to-brand-700/20"></div>
        ...
        >
          ...
          >
            <motion.button
              ...
              className="bg-white text-brand-600 hover:bg-gray-100 font-bold px-10 py-5 rounded-2xl transition-all duration-200 shadow-2xl hover:shadow-3xl text-xl inline-flex items-center group"
            >
          ...
          <motion.div
            ...
            className="text-center"
          >
            <p className="text-brand-200 text-lg font-medium mb-4">
          ...
          >
            ...
            <motion.a 
              ...
              className="text-brand-300 hover:text-brand-200 font-semibold text-xl transition-colors duration-200"
            >
