                  ...
                  <div className="flex items-start mb-6">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="bg-green-50 px-3 py-2 rounded-full inline-block">
                        <span className="text-green-700 font-semibold text-sm">{system.outcome}</span>
                      </div>
                    </div>
                  </div>
                ...
                <div key={index} className="bg-white rounded-2xl shadow-lg p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-green-50 rounded-lg p-3">
                      ...
                      <div className="text-xs text-green-700">{tactic.metrics}</div>
                    </div>
                  </div>
                </div>
              ))}
            ...
            <div className="mt-6">
              <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  ...
                  <div className="bg-green-50 rounded-lg p-3">
                    <div className="text-sm font-semibold text-green-800">Performance Impact:</div>
                    <div className="text-xs text-green-700">{facebookTactics[4].metrics}</div>
                  </div>
                </div>
              </div>
            </div>
