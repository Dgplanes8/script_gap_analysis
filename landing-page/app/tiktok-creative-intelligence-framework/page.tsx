          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                ...
                <div className="text-brand-200 text-sm">Trend adoption speed</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                <Video className="h-8 w-8 text-brand-200 mx-auto mb-2" />
                <div className="text-2xl font-bold">4x Higher</div>
                <div className="text-brand-200 text-sm">Engagement rates</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                <Users className="h-8 w-8 text-brand-200 mx-auto mb-2" />
                <div className="text-2xl font-bold">25% Increase</div>
                <div className="text-brand-200 text-sm">Trial conversion rates</div>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                ...
                <div className="text-brand-200 text-sm">Trend adoption</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                <Video className="h-8 w-8 text-brand-200 mx-auto mb-2" />
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                ...
                <div className="text-brand-200 text-sm">Trial conversions</div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <FreeWeekButton source="tiktok_creative_intelligence_framework-cta" className="border-2 border-white text-white hover:bg-white hover:text-brand-600 font-bold py-4 px-8 rounded-lg transition-all duration-200 flex items-center justify-center">Start Free Week Trial</FreeWeekButton>
            </div>
          </div>
        </div>
      </section>
