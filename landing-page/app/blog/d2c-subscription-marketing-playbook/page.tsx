            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-12">
                ...
                <div className="bg-brand-50 rounded-lg p-6 my-8">
                  <h3 className="text-xl font-semibold text-brand-900 mb-4">D2C Subscription Market Insights</h3>
                ...
                <div className="bg-gradient-to-r from-brand-50 to-brand-50 rounded-lg p-8 mb-8">
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="text-center">
                      <div className="bg-brand-600 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                        <span className="text-white font-bold text-lg">70%</span>
                      </div>
                      <h4 className="font-semibold text-brand-900 mb-2">Educational Content</h4>
                      <p className="text-brand-800 text-sm">Case studies, insights, tutorials that demonstrate value and expertise</p>
                    </div>
                    <div className="text-center">
                      <div className="bg-brand-600 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                        <span className="text-white font-bold text-lg">20%</span>
                      </div>
                      <h4 className="font-semibold text-brand-900 mb-2">Community Engagement</h4>
                      <p className="text-brand-800 text-sm">User-generated content, testimonials, community interactions</p>
                    </div>
                    <div className="text-center">
                      <div className="bg-brand-600 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                        <span className="text-white font-bold text-lg">10%</span>
                      </div>
                      <h4 className="font-semibold text-brand-900 mb-2">Promotional Content</h4>
                      <p className="text-brand-800 text-sm">Product features, special offers, direct calls-to-action</p>
                    </div>
                  </div>
                </div>
              ...
              <section className="mb-12">
                ...
                <div className="space-y-6">
                  <div className="bg-brand-50 rounded-lg p-6">
                    <h4 className="text-lg font-semibold text-brand-900 mb-3">Personalization at Scale</h4>
                    <p className="text-brand-800 mb-3">Leverage customer data to create personalized experiences that increase engagement and reduce churn.</p>
                  ...
                  <div className="bg-brand-50 rounded-lg p-6">
                    <h4 className="text-lg font-semibold text-brand-900 mb-3">Community-Driven Retention</h4>
                    <p className="text-brand-800 mb-3">Build strong customer communities that create emotional connections and increase switching costs.</p>
                    <ul className="space-y-1 text-brand-700 text-sm">
              ...
              <section className="mb-12">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-8">
                  <div className="bg-gradient-to-br from-brand-50 to-brand-50 rounded-lg p-6">
                    <h4 className="text-lg font-semibold text-brand-900 mb-4">Community Activation Tactics</h4>
                    <ul className="space-y-2 text-brand-800">
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-brand-50 rounded-lg p-6">
