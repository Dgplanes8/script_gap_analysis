          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-gradient-to-br from-brand-600 to-brand-700 text-white rounded-2xl p-8 text-center mb-12">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <FreeWeekButton source="growth_team_creative_bottlenecks-cta" className="bg-white text-brand-600 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors inline-flex items-center">Claim 10 Free Credits</FreeWeekButton>
              </div>
