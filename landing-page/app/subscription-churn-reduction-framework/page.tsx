      ...
      <div className="min-h-screen bg-gradient-to-br from-brand-50 to-brand-100 pt-16 lg:pt-20">
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center px-4 py-2 bg-brand-100 rounded-full text-brand-700 text-sm font-medium mb-6">
              <span className="w-2 h-2 bg-brand-600 rounded-full mr-2"></span>
              Retention Intelligence Framework
            </div>
            
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Cut Subscription Churn <span className="text-brand-600">35% in 90 Days</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              <div className="bg-white rounded-lg p-6 shadow-md">
                <div className="text-3xl font-bold text-brand-600 mb-2">35%</div>
                <div className="text-gray-600">Average churn reduction in 90 days</div>
              </div>
              <div className="bg-white rounded-lg p-6 shadow-md">
                <div className="text-3xl font-bold text-brand-600 mb-2">14 Days</div>
                <div className="text-gray-600">Early warning system detection</div>
              </div>
              <div className="bg-white rounded-lg p-6 shadow-md">
                <div className="text-3xl font-bold text-brand-600 mb-2">4x</div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-gradient-to-br from-brand-50 to-brand-50 rounded-xl p-8">
                <div className="flex items-center mb-4">
                  <div className="w-10 h-10 bg-brand-600 rounded-full flex items-center justify-center text-white font-bold mr-4">1</div>
              ...
              <div className="bg-gradient-to-br from-brand-50 to-blue-50 rounded-xl p-8">
                <div className="flex items-center mb-4">
                  <div className="w-10 h-10 bg-brand-600 rounded-full flex items-center justify-center text-white font-bold mr-4">3</div>
              ...
              <div className="bg-gradient-to-br from-brand-50 to-brand-50 rounded-xl p-8">
                <div className="flex items-center mb-4">
                  <div className="w-10 h-10 bg-brand-600 rounded-full flex items-center justify-center text-white font-bold mr-4">4</div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-xl p-8 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                <div className="text-center">
                  <div className="text-3xl font-bold text-brand-600 mb-2">8.5%</div>
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-brand-600 mb-2">$840K</div>
