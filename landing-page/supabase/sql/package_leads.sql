-- Package leads table (if you are applying manually via SQL editor)
...
CREATE POLICY IF NOT EXISTS "Service role can manage package leads" ON public.package_leads
